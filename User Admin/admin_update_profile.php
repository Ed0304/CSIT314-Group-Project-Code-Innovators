...
class UserProfile {
    public function getProfileDetails($conn, $profile_id) {
        ...
        if (!$stmt) {
            error_log("Profile details retrieval failed: " . $conn->error);
            return false;
        }
...
class UserProfileController {
    ...
    public function handleRequest($conn, $profile_id) {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $data['profile_id'] = $profile_id; // Include profile_id
    ...
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="button-group">
                ...
                <a href="profileDetails.php?profile_id=<?= htmlspecialchars($this->profile['profile_id']); ?>">
...
$profile_id = $_GET['profile_id']; // Get profile_id from URL
$model = new UserProfile();
$controller = new UserProfileController($model);
$profile = $controller->handleRequest($conn, $profile_id);
