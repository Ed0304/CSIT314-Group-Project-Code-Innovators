...
$testProfiles = [
    ...
    [
        ...
        'gender' => 'M',
        'profile_image' => loadImageAsBlob('C:/xampp/htdocs/CSIT314-Project/testdata/profile_images/takumi.jpg'),
        'status_id' => 1,
    ],
    [
        'user_id' => 4,
        ...
        'gender' => 'M',
        'profile_image' => loadImageAsBlob('C:/xampp/htdocs/CSIT314-Project/testdata/profile_images/bunta.jpg'),
        'status_id' => 1,
    ],
    [
        'user_id' => 5,
        ...
        'gender' => 'M',
        'profile_image' => loadImageAsBlob('C:/xampp/htdocs/CSIT314-Project/testdata/profile_images/muzan.jpg'),
        'status_id' => 1,
    ],
];
