...
// ENTITY LAYER: Represents Seller Profile
class SellerAccount
{
...
class UpdateSellerInformationController
{
    private $model;
...
class UpdateSellerInformationPage
{
    private $profile;
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="first_name" name="first_name"
                            value="<?= htmlspecialchars($this->profile['first_name']); ?>" required />
                    </div>
                    <div class="form-group">
                        <label for="last_name">Last Name:</label>
                        <input type="text" id="last_name" name="last_name"
                            value="<?= htmlspecialchars($this->profile['last_name']); ?>" required />
                    </div>
                    <div class="form-group">
                        <label>Gender:</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phone_num" name="phone_num"
                            value="<?= htmlspecialchars($this->profile['phone_num']); ?>" required />
                    </div>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" id="email" name="email" value="<?= htmlspecialchars($this->profile['email']); ?>"
                            required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="button-group">
                        ...
                        <a href="seller_manage_profile.php">
...
$model = new SellerAccount();
$controller = new UpdateSellerInformationController($model);
$profile = $controller->handleRequest($conn, $profile_id); // Changed to profile_id
$view = new UpdateSellerInformationPage($profile);
$view->render();
?>