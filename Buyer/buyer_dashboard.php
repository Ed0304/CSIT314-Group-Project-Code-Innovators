...
// Entity: CarListing handles both database connection and operations
class CarListing
{
    private static $conn;
    ...
    public static function getAllListings()
    {
        ...
        while ($row = $result->fetch_assoc()) {
            $listings[] = new CarListing($row);
        }
        return $listings;
    }

    // Searches listings based on criteria
    public static function searchListings($criteria, $search)
    {
        self::connect();
        $query = "
            SELECT 
...
// Controller: Simply relays calls to the CarListing entity
class SearchUsedCarController
{
    public function getAllListings()
    {
        return CarListing::getAllListings();
    }

    public function searchUsedCar($criteria, $search)
    {
        return CarListing::searchListings($criteria, $search);
    }
}
...
class SearchUsedCarPage
{
    ...
    public function render()
    {
        ...
        if ($searchUsedCar) {
            $listings = $this->controller->searchUsedCar($criteria, $search);
        } else {
        ...
        <body>
            <header>
                ...
                <a href="buyer_manage_profile.php?user_id=<?php echo $buyerID; ?>">Manage Account</a>
